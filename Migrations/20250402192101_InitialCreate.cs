    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitapKategoriler", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KitapKategoriId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KayitTarihi = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AktifMi = table.Column<bool>(type: "INTEGER", nullable: false),
                    OnayDurumu = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Siniflar_SinifId",
                        column: x => x.SinifId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitapKimde", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KitapKimde_AspNetUsers_OgrenciId",
                        column: x => x.OgrenciId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KitapKimde_Kitaplar_KitapId",
                        column: x => x.KitapId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitapKimde_KitapId",
                table: "KitapKimde",
                column: "KitapId");

            migrationBuilder.CreateIndex(
                name: "IX_KitapKimde_OgrenciId",
                table: "KitapKimde",
                column: "OgrenciId");

            migrationBuilder.CreateIndex(
                name: "IX_Kitaplar_KitapKategoriId",
                table: "Kitaplar",
